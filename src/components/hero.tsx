        ...
        <div className="w-full bg-white py-12 md:py-16 lg:py-20">
            <div className="container mx-auto px-4 md:px-6 max-w-4xl">
                <div className="flex flex-col items-center text-center space-y-6">
                    ...
                    <p className="text-sm md:text-base text-[#767676] max-w-3xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-4 w-full sm:w-auto">
                        <button className="px-6 py-3 rounded-md bg-[#335CFF] text-white font-medium hover:bg-[#335CFF]/90 transition-colors">
                            Explore Our Ecosystem
                        </button>

                        <button className="px-6 py-3 rounded-md bg-[#F5F7FA] text-gray-800 font-medium hover:bg-[#F5F7FA]/90 transition-colors">
                            Partner with Us
                        </button>
                    </div>
                </div>
